...
const styles = StyleSheet.create({
  ...
  checkRow: { flexDirection: 'row', alignItems: 'center', alignSelf: 'flex-start', marginBottom: 24 },
  checkbox: {
    width: 22, height: 22, borderRadius: 4, borderWidth: 2,
    borderColor: '#333', alignItems: 'center', justifyContent: 'center', marginRight: 8,
  },
